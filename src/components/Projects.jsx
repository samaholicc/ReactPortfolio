        ...
        {projects.map((project, index) => (
          <div key={index} className="flip-card w-64 h-64 relative">
            <div className="flip-card-inner">
              {/* Front Face */}
              <div className="flip-card-front card-content flex flex-col justify-center h-full bg-white rounded-lg shadow-md">
                <img
                  src={project.image}
                  alt={project.name}
              ...
              {/* Back Face */}
              <div className="flip-card-back card-content flex flex-col justify-center h-full bg-white rounded-lg shadow-md"> 
